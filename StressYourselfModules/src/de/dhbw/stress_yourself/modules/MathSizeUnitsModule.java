...
/**
 * The MathSizeUnitsModule class builds a module where user has to convert numbers from kilobyte, megabyte or kilobyte in another size unit.
 * 
...
public class MathSizeUnitsModule extends ModuleClass {
	 ...
	 * 			exercise[0] is the number with the size unit
	 * 			exercise[1] is the size unit to which the user should convert the given number
