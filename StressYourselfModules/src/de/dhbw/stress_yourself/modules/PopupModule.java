...
/**
 * This class generates a reaction test. The aim is to click on a button as fast
 * as you can
 * 
...
public class PopupModule extends ModuleClass {
	...
	/**
	 * Configurates the time per button and the number of buttons which can be
	 * clicked depending on the difficulty
	 */
	 ...
	 * 
	 * @return Point for button location
	 */
	...
	class ModuleGUI extends JPanel implements ActionListener {
		...
		public ModuleGUI() {
			...
			this.add(getIntroductionPanel(timePerButton, numberOfButtons, this));
		}
		...
		/**
		 * Calculates the result Close the module
		 */
		...
		/**
		 * Actionlistener for the buttons. Finishes the modules Starts the test
		 */
		@Override
		public void actionPerformed(ActionEvent e) {
			if (buttons.contains(e.getSource())) {
				...
				if (buttonClicked == buttonCounter) {
					...
					buttons.get(buttons.indexOf(e.getSource())).setVisible(
							false);
				}
