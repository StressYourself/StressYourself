...
/**
 * The MathPotenciesModule class builds a module where user has to solve simple equation systems.
 * 
...
public class MathEquationSystemsModule extends ModuleClass {
	 ...
	 * 			exercise[0] is the x value
	 * 			exercise[1] is the y value
	 * 			exercise[2] is the first equation
	 * 			exercise[3] is the second equation
	 * 
	 * @author Philipp Willems
	 */	
	...
	class moduleGUI extends JPanel implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			case 0:
				...
				if (xPane.getText().equals(exercise[0]) && xPane.getText().equals(exercise[1])) {
